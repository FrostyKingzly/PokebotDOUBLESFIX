...
class PokemonSpriteHelper:
    ...
    SHOWDOWN_FALLBACK = "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/showdown/{id}.gif"
    ...
    def get_sprite(pokemon_name: str, dex_number: Optional[int] = None, 
        ...
        Args:
            ...
            dex_number: National Dex number (required for 'animated', 'static', and 'official' styles)
        ...
        if style == 'animated':
            ...
            # Use Gen 5 pixel art for Gen 1-5 (dex #1-649)
            # Fall back to Showdown 3D sprites for Gen 6+ (dex #650+)
            if dex_number <= 649:
                return PokemonSpriteHelper.GEN5_ANIMATED.format(id=dex_number)
            else:
                return PokemonSpriteHelper.SHOWDOWN_FALLBACK.format(id=dex_number)
